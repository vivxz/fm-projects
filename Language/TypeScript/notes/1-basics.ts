 ...
 */
let x = "hello world"; // takes on a type of string
 ...
 */
// x = 42; // 🚨 ERROR 42 !== 'string'

/**
 * (4) let's look at const. The type is literally 'hello world'
 */
const y = "hello world"; // takes on a type of 'hello world' -- literal type
 ...
 */
let z; // takes on a type of any -- top type: wild cards
z = 41;
 ...
 */
let zz: number; // initialize the variable with a type number
zz = 41;
 ...
 */
let aa: number[] = []; // let aa = [] -- type never which can never work
aa.push(33);
...
let bb: [number, string, string, number] = [
  ...
  "Nowhere, USA",
  10110
]; // can only be the length of 4

// bb.push(1, 2, 3) -- this would work because it'll take either number || string
...
contactInfo.name; // NOTE: we can only access the .name property  (the stuff HasPhoneNumber and HasEmail have in common) -- middle part of a venn diagram
